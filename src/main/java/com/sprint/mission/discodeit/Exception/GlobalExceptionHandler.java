...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleChannelUpdateNotAllowedException(
  ...
  public ResponseEntity<ErrorResponse> handleNotExistReadStatusException(
      NotExistReadStatusException e) {
