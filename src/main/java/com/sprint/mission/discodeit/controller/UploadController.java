...
public class UploadController {
  ...
  public ResponseEntity<String> multifleUpload(@RequestParam List<MultipartFile> multiFiles,
    ...
    try {
      for (MultipartFile file : multiFiles) {
        ...
        files.add(
            new BinaryContentResponse(originalFileName, savedName, uploadPath, contentType, bytes,
                multiFileDescription, Instant.now()));
  ...
  public ResponseEntity<BinaryContentResponse> find(
      @RequestParam(value = "id") UUID binaryContentId) {
